...
# Parser
The parser should remain pretty much the same, the goal of this module is to read in netlist file generated by KiCad, and build a list of components that are used. And then return this so it can be sent to middleware.
